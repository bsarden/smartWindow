...
void setupJSONify() {
    ...
    wifiReady.waitFor();                    // waits for a wireless connection before starting to create events
}
...
void loopJSON(){
    ...
    // aJson.addNumberToObject(d, "light", light);      // used to add int value, makes jsonPayload not a "true" JSON Object
